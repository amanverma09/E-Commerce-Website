...
const Cart = () => {
  ...
  const handleQuantity = async (id, type) => {
    ...
    await axios.put(`https://e-commerce-website-kappa-opal.vercel.app/api/cart/update/${id}`, {
      quantity: updatedItem.quantity,
    });
  };

  const handleDelete = async (id) => {
    await axios.delete(`https://e-commerce-website-kappa-opal.vercel.app/api/cart/${id}`);
                  ...
                  <div className="row">
                    <div className="col-md-3 col-4">
                      <NavLink to={`/product/${item.productId._id}`}>
                        <img
                          src={`https://e-commerce-website-kappa-opal.vercel.app/uploads/${item.productId.images[0]}`}
